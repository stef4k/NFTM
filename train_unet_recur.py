...
from unet_model_recur import RecUNet
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--base", type=int, default=10, help="Base channel width for RecuUNet")
...
def main() -> None:
    ...
    model = RecUNet(in_ch=4, out_ch=3, base=args.base,rec_steps = 3).to(device)
