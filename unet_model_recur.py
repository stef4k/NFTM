...
class RecUNet(nn.Module):
    ...
    def __init__(self, in_ch: int = 4, out_ch: int = 3, base: int = 10, rec_steps: int = 3) -> None:
        ...
        self.out_rec_conv = nn.Conv2d(enc_ch1, 4, kernel_size=3, padding=1, bias=True)
...
def _smoke_test() -> None:
    ...
    model = RecUNet(in_ch=4, out_ch=3, base=10).to(device)
