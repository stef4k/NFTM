...
def eval_steps_sidd_denoise(
    ...
    for bidx, (noisy, gt) in enumerate(loader):
        ...
        I = noisy.clone()
        I_metrics0 = I.clamp(-1.0, 1.0)
        step_psnrs = [_metric_psnr(I_metrics0, gt).item()]
        step_ssims = [_metric_ssim(I_metrics0, gt).item()]
        step_lpips = [_metric_lpips(I_metrics0, gt).item()]
